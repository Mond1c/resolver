...
internal fun List<ResolutionStep>.withTeamIdOrNull(i: Int): ResolutionStep.WithTeamId? {
    val got = get(i)
    if (got is ResolutionStep.WithTeamId.AcceptResolutionStep ||
        got is ResolutionStep.WithTeamId.RejectResolutionStep ||
...
internal fun ContestState.getProblemDisplayName(problemId: ProblemId): String {
    ...
    val problem =
        infoAfterEvent.problems[problemId] ?: throw CoreExceptions.problemNotFoundException
